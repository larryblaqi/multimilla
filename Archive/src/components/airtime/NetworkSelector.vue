...
const filteredProviders = computed(() => {
  const localProviders =
    props.serviceProviders?.filter(
      (provider) =>
        !provider.serviceID.toLowerCase().includes("foreign-airtime")
    ) || [];
...
<template>
  <!-- Form Header -->
  <div class="mb-8 mt-8">
    <h1 class="text-2xl md:text-3xl font-bold mb-2 text-gray-600">Airtime Top-up</h1>
